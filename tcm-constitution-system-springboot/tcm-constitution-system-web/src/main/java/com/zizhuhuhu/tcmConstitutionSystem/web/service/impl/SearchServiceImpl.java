...
import com.zizhuhuhu.tcmConstitutionSystem.web.model.vo.search.SearchArticlePageListRspVO;
...
public class SearchServiceImpl implements SearchService {
        ...
        @Override
        public Response searchArticlePageList(SearcheArticlePageListReqVO searchArticlePageListReqVO) {
            ...
            // 执行搜索（分页查询）String indexDir, String word, String[] columns, int current, int size
