package com.example.weblog.module.jwt.filter;


import com.example.weblog.module.jwt.JwtTokenHelper;
        ...
        if(requestURL.startsWith("/admin")) {
            ...
            if (StringUtils.startsWith(header, tokenPrefix)) {
                ...
                if (StringUtils.isNotBlank(token)) {
                    ...
                    } catch (DecodingException | MalformedJwtException | UnsupportedJwtException | IllegalArgumentException e) {
