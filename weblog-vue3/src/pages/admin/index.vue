    ...
    <main class="container p-4">
        ...
        <div class="grid grid-cols-4 gap-7">
         <!-- 文章数 -->
          <div class="col-span-4 md:col-span-1">
                <!-- 卡片 -->
                <div class="flex items-center w-full h-full px-5 py-7 mb-3 bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="col-span-4 md:col-span-2">
            ...
            <div
                ...
                <ArticlePublicCalendar :value="articlePublishInfo"></ArticlePublicCalendar>
               <div>
                内容
               </div>
            </div>
...
<script setup>
                    ...
                    import ArticlePublicCalendar from '@/components/ArticlePublicCalendar.vue'
