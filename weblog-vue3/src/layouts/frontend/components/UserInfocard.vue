    ...
    <div class="w-full py-5 px-2 mb-3 bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700">
        <div class="flex flex-col items-center">
            ...
            <div class="flex justify-center gap-2">
                <!-- GitHub -->
                <svg v-if="blogSettingsStore.blogSettings.githubHomepage" @click="jump(blogSettingsStore.blogSettings.githubHomepage)" t="1698029949662" data-tooltip-target="github-tooltip-bottom" data-tooltip-placement="bottom"
                ...
                <div id="github-tooltip-bottom" role="tooltip"
                    class="a bsolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
                    我的 GitHub
                    <div class="tooltip-arrow" data-popper-arrow></div>
                </div>
                <!-- Gitee -->
                <svg v-if="blogSettingsStore.blogSettings.giteeHomepage" @click="jump(blogSettingsStore.blogSettings.giteeHomepage)" t="1698030969736" data-tooltip-target="gitee-tooltip-bottom" data-tooltip-placement="bottom"
                    class="hover:scale-110 icon mt-5 w-7 h-7" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                ...
                <!-- 知乎 -->
                <svg v-if="blogSettingsStore.blogSettings.zhihuHomepage" @click="jump(blogSettingsStore.blogSettings.zhihuHomepage)" t="1698031258903" data-tooltip-target="zhihu-tooltip-bottom" data-tooltip-placement="bottom"
                    class="hover:scale-110 icon mt-5 w-7 h-7" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                ...
                <!-- CSDN -->
                <svg v-if="blogSettingsStore.blogSettings.csdnHomepage" @click="jump(blogSettingsStore.blogSettings.csdnHomepage)" t="1698031311586" data-tooltip-target="csdn-tooltip-bottom" data-tooltip-placement="bottom"
                    class="hover:scale-110 icon mt-5 w-7 h-7" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
